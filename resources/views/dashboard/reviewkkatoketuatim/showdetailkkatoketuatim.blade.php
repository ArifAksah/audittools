<x-app-layout>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                                    <div class="modal-dialog">
                                        <form action="{{ route('reviewkkaketuatim.notes', $lhap->id) }}" method="POST" class="modal-content" id="addNoteForm">
                                            @csrf
                        ...
                        <h1 class="text-center">KERTAS KERJA AUDIT REVIU KETUA TIM</h1>
    ...
    <!-- / Layout page -->
    <script src="{{ asset('js/reviewketuatim/multiplefieldketuatim.js') }}"></script>
</x-app-layout>
